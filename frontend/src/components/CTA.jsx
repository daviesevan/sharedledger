      ...
      <section className="bg-white dark:bg-gray-900">
        <div className="gap-8 items-center py-8 px-4 mx-auto max-w-screen-xl xl:gap-16 md:grid md:grid-cols-2 sm:py-16 lg:px-6">
          ...
          <div className="mt-4 md:mt-0">
            ...
            Experience the easiest way to track, split, and manage shared expenses.
            </h2>
            <p className="mb-6 font-medium text-gray-500 md:text-lg dark:text-gray-400">
            Don't let the hassle of managing shared expenses weigh you down. Take control with Sharedledger and enjoy a more organized and stress-free way to handle your finances.
            </p>
            <a
              href="#"
